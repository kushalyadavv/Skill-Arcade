      ...
      <Grid item lg={5} sm={7} xs={12}>
        <Card sx={{ width: '100%', height: '100%' }}>
          ...
          <Box textAlign='center' sx={{ mt: 6 }}>
            <BookIcon sx={{ color: 'black', fontSize: 100 }} />
            <Typography variant='h5' sx={{ fontWeight: 'bold' }}>Skill Arcade</Typography>
            <footer sx={{position: 'relative', bottom: 0, left: 0}}>
      <p>© 2022 Kushal Yadav All rights reserved.</p>
    </footer>
          </Box>
        </Card>
      </Grid>
