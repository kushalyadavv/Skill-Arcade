  ...
  return <>
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" color="primary">
        <Toolbar>
          <Typography variant='h5' component="div" sx={{ flexGrow: 1 }}>Skill Arcade</Typography>
          ...
          <Button component={NavLink} to='/' style={({ isActive }) => { return { backgroundColor: isActive ? 'primary' : '' } }} sx={{ color: 'white', textTransform: 'none' }}>Login/Registration</Button>
